...
void udf::frame_size_calculator::do_mem_alloc_node(udf::mem_alloc_node *const node, int lvl) {
  // EMPTY
}
...
void udf::frame_size_calculator::do_pointer_index_node(udf::pointer_index_node *const node, int lvl) {
  // EMPTY
}
