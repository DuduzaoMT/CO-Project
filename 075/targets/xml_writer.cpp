...
void udf::xml_writer::do_mem_alloc_node(udf::mem_alloc_node * const node, int lvl) {
  openTag(node, lvl);
  node->argument()->accept(this, lvl + 2);
  closeTag(node, lvl);
}
...
void udf::xml_writer::do_pointer_index_node(udf::pointer_index_node * const node, int lvl) {
  openTag(node, lvl);
  openTag("base", lvl);
...
void udf::xml_writer::do_for_node(udf::for_node * const node, int lvl) {
  ...
  openTag("increment", lvl);
  node->increment()->accept(this, lvl + 4);
  closeTag("increment", lvl);
  openTag("block", lvl);
...
void udf::xml_writer::do_tensor_index_node(udf::tensor_index_node *const node, int lvl) {
  ...
  if (node->positions()) node->positions()->accept(this, lvl + 4);
...
void udf::xml_writer::do_tensor_reshape_node(udf::tensor_reshape_node *const node, int lvl) {
  ...
  closeTag("base", lvl + 2);
  openTag("sizes", lvl + 2);
  if (node->sizes()) node->sizes()->accept(this, lvl + 4);
  closeTag("sizes", lvl + 2);
  closeTag(node, lvl);
}